__all__ = ["PureyakError", "InvalidChoiceError"]

from collections.abc import Sequence
from typing import Any


class PureyakError(Exception):
    """Base exception for all errors raised by pureyak."""
...
class InvalidChoiceError(PureyakError, ValueError):
    """Raised when a value is not one of an allowed set of choices.

    Examples
    --------
    >>> import pureyak
    >>> err = pureyak.exceptions.InvalidChoiceError(value=0, choices=[1, 2, 3])
    >>> err.message
